...
Since we started taking donations from GitHub Sponsors in February 2020,
we collected 139.35 € through that program.
Thanks a lot to [our sponsors](https://github.com/sponsors/avdgrinten)!

The money was spent as follows:
Between March 2020 and July 2021, we payed 396.88 € for compute resources.
Additionally, we spent 80 € for hardware (on a Raspberry Pi 4 + accessories
to test the AArch64 port).
The difference (i.e., a cost of 337.53 €) was payed by
[@avdgrinten](https://github.com/avdgrinten).

If you want to support Managarm, please consider
